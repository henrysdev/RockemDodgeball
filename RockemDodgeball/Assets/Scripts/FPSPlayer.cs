...
public class FPSPlayer : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (IsGrounded())
        {
            ...
            //{
            //    //Vector3 newA = (m_velocity + Vector3.up).normalized;
            //    m_Rigid.AddForce(Vector3.up * Mathf.Sqrt(jumpForce * -2f * Physics.gravity.y), ForceMode.Impulse);
            //    //isGrounded = false;
            //}
            ...
            //animate
            if (m_velocity.magnitude > 0 && !walkingAnim.isPlaying)
                walkingAnim.Play();
